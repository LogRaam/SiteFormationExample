...
Site statique de référence et de formation interactive sur l'utilisation des Feature Flags avec LaunchDarkly chez Desjardins.
...
3. Intégrer les spécificités Desjardins : SOC2, PR automatique, approbation séparée, catalogue central et types de switches.
...
- Exemples concrets Desjardins, preuves d'audit et modèles de communication.
